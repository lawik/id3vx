defmodule Id3vx.EncodingTest do
  ...
  test "v2.3 encoding CHAP frame" do
    ...
    assert <<"TIT2", frame_size::size(32), flags::binary-size(2), frames_data::binary>> = sub_frames
    ...
    assert <<"TIT3", frame_size::size(32), flags::binary-size(2), frames_data::binary>> = more_frames
